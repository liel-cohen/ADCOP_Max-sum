...
//Start with regular MaxSum for 2 CYLCEs, then perform VP for 2 other CYCLEs, then perform MaxSumAD for 2 more CYCLEs
//(to work both directions), and finally perform regular MaxSumADVP
//(4,STD),(4,VP),(4,AD),(the rest,ADVP)
//***************

@Algorithm(name="STD_VP_AD_ADVP", useIdleDetector=false)
public class STD_VP_AD_ADVP extends MaxSumAgent {
