...
//**********
//NOTE: this problem generator creates an UNSTRUCTURED ADCOP problem, with multiplication of the value by a 1000,
//which is used for adding personal preferences later.
//(used for adding unary constraints later via the VariableNode class)
//**********

@Register(name="adcop-noise")
public class ADCOPNoiseGen extends GeneralDCOPGen {
